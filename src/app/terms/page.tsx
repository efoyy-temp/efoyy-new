        ...
        <div className="max-w-3xl mx-auto">
          ...
          <div className="prose max-w-none">
            ...
            <section id="section-2" className="scroll-mt-20 mt-8">
              ...
              <h3 className="text-lg font-medium mt-4">{t('section2.1.title')}</h3>
              <p>{t('section2.1.p')}</p>

              <h3 className="text-lg font-medium mt-4">{t('section2.2.title')}</h3>
              <p>{t('section2.2.p')}</p>
              <ul className="list-disc pl-5 space-y-1">
                <li><strong>{t('section2.2.riderTitle')}</strong> {t('section2.2.riderDescription')}</li>
                <li><strong>{t('section2.2.driverTitle')}</strong> {t('section2.2.driverDescription')}</li>
              </ul>

              <h3 className="text-lg font-medium mt-4">{t('section2.3.title')}</h3>
              <p>{t('section2.3.p')}</p>
            </section>
            ...
            <section id="section-3" className="scroll-mt-20 mt-8">
              ...
              <h3 className="text-lg font-medium mt-4">{t('section3.1.title')}</h3>
              <p>{t('section3.1.p')}</p>
              <ul className="list-disc pl-5 space-y-1">
              ...
              <h3 className="text-lg font-medium mt-4">{t('section3.2.title')}</h3>
              <p>{t('section3.2.p')}</p>
              <ul className="list-disc pl-5 space-y-1">
              ...
              <h3 className="text-lg font-medium mt-4">{t('section3.3.title')}</h3>
              <p>{t('section3.3.p')}</p>
              <ul className="list-disc pl-5 space-y-1">
            ...
            <section id="section-4" className="scroll-mt-20 mt-8">
              ...
              <h3 className="text-lg font-medium mt-4">{t('section4.1.title')}</h3>
              <p>{t('section4.1.p')}</p>

              <h3 className="text-lg font-medium mt-4">{t('section4.2.title')}</h3>
              <p>{t('section4.2.p')}</p>

              <h3 className="text-lg font-medium mt-4">{t('section4.3.title')}</h3>
              <p>{t('section4.3.p')}</p>
            </section>
